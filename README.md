...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/auto-labeling-pipeline-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13329&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/auto-labeling-pipeline-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `auto-labeling-pipeline` can be installed with:

```
conda install auto-labeling-pipeline
```

It is possible to list all of the versions of `auto-labeling-pipeline` available on your platform with:
